export default function LaravelCards(){
    return(
        <div onClick={()=>document.getElementById('my_modal_1').showModal()} className=" w-80 h-52 bg-white rounded-xl hover:drop-shadow-2xl duration-200 border border-black hover:bg-red-200">
